...
//import com.trsoft.catmovie.adapter.DanamakuAdapter;
//import com.trsoft.catmovie.constant.BiliDanmukuParser;
//
...
//    private boolean mDanmaKuShow = true;//弹幕显示
//    private long mDanmakuStartSeekPosition = -1;//弹幕进度位置
...
//        initDanmaku();
//
//        mSendDanmaku.setOnClickListener(new OnClickListener() {
//            @Override
...
//                            resolveDanmakuSeek(CustomGSYVideoPlayer.this, getDanmakuStartSeekPosition());
...
//        ((CustomGSYVideoPlayer) to).mDumakuFile = ((CustomGSYVideoPlayer) from).mDumakuFile;
...
//            CustomGSYVideoPlayer gsyVideoPlayer = (CustomGSYVideoPlayer) gsyBaseVideoPlayer;
//            //对弹幕设置偏移记录
...
//            CustomGSYVideoPlayer gsyDanmaVideoPlayer = (CustomGSYVideoPlayer) gsyVideoPlayer;
...
//            onPrepareDanmaku((CustomGSYVideoPlayer) getCurrentPlayer());
//        }
//    }
//    /**
//     开始播放弹幕
//     */
//    private void onPrepareDanmaku(CustomGSYVideoPlayer gsyVideoPlayer) {
...
//     弹幕偏移
//     */
//    private void resolveDanmakuSeek(CustomGSYVideoPlayer gsyVideoPlayer, long time) {
...
//     释放弹幕控件
//     */
//    private void releaseDanmaku(CustomGSYVideoPlayer danmakuVideoPlayer) {
...
//        Toast.makeText(mContext,"点击了弹幕",Toast.LENGTH_LONG).show();
